...
<html>
    ...
    <body>
        <div class="col-sm-12 ">
            <div class="row">
                <div class="col-sm-12 h">
                    ...
                    <div class="text-center h1"><b style=" color:#ff5a60;font-family:Comic Sans MS;">MARRIAGE REQUEST<span class="fa fa-users"></span></b></div>
      ...
      String cmd="select * from mreq where  ReqTo='"+session.getAttribute("uid")+"' and status='Pending'";
                    ...
                    <div class="col-sm-12 text-center">
                     ...
                     <div class="col-sm-12" >
                        ...
                        <center>
                            ...
                            <img src="../AdminZone/img/<%out.print(rs2.getString("Photo"));%>" style="margin-top: 3%;padding-top: 2%;height: 130px;width:130px;"/></center>
                    </div> 
                    
                    <div style="margin-top:3%;" class="col-sm-12">
                        <a href="viewprofile.jsp?email=<%out.print(rs2.getString("email"));%>">
                            <input type="button" style="color:white;text-shadow:none;font-size:13px;" value="View Profile" class="btn1"/></a>
                         <a href="../code/AcceptReq.jsp?email=<%out.print(rs2.getString("email"));%>">
                            <input type="button" style="color:white;text-shadow:none;font-size:13px;" value="Accept Request" class="btn1"/></a>
